...
int main()
{
    ...
    buttons.push_back(new Button(font, {660, 340}, {120, 30}, "Unimplemented", [&images, &selectedImage](){images[selectedImage]->advancedFeature2();}));
    buttons.push_back(new Button(font, {660, 380}, {120, 30}, "Invert Colours", [&images, &selectedImage](){images[selectedImage]->advancedFeature3();}));
